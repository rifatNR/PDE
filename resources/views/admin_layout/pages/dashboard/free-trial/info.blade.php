    ...
    <div class="row">
        <div class="col-12">
            <div class="col-12 mt-3 p-2 mb-15 d-flex float-right">
                    ...
                    @endif
                    @include('admin_layout.pages.dashboard.free-trial.status_update_modal')

                    @if($order->status == 'completed' )
                        <h4 class="col-sm">
                            <small id="updateBtn" data-toggle="modal" data-target="#addUrlModal{{ $order->id }}">
                                <span data-toggle="tooltip" data-theme="dark" title="Add URL" class="m-2">
                                    <i class="fas fa-link text-info" onclick="addUrl({{ $order->id }})"></i>
                                </span>
                            </small>
                        </h4>
                        ...
                        @endif
                    @endif
                    @include('admin_layout.pages.dashboard.free-trial.add_url_modal')
            </div>
            <!-- Main content -->
            ...
            <div class="p-3 mb-3">
                ...
                <div class="row invoice-info mb-15">
                    <div class="col-sm-6 invoice-col">
                        <div class="card text-white bg-secondary mb-3">
                            <div class="card-header" style="font-size:20px; font-style:italic;">From</div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 invoice-col">
                        <div class="card text-white bg-secondary mb-3">
                            <div class="card-header" style="font-size:20px; font-style:italic;">Time</div>
                            <div class="card-body">
                ...
                {{-- <div class="row"> --}}
                    ...
                    @if($order->status == 'new')
                        <div class="row ">
                            <button type="button" class="btn btn-success ml-2" data-toggle="modal" data-target="#acceptModal{{ $order->id }}">
                                <i class="far fa-check-circle"></i>
                                Accept
                            </button>
                            @include('admin_layout.pages.dashboard.free-trial.accept_modal')

                            <button type="button" class="btn btn-danger ml-2" data-toggle="modal" data-target="#rejectModal{{ $order->id }}">

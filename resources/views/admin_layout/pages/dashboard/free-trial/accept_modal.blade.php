            ...
            <form action="{{ route('admin.free-trial.action', ['id'=>$order->id]) }}" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="s_date" placeholder="Enter starting date" value="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Ending date</label>
                        <input type="datetime-local" class="form-control" id="e_date" placeholder="Enter ending date" value="">
                    </div>
                </div>

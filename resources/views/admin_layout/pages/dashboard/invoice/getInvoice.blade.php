...
<div class="container inv" id="invoiceId">
    ...
    <div class="row ">
        <div class="col-lg-12">
            <table class="table table-bordered mt-3"  style="overflow-wrap: anywhere;">
                <thead style="background-color: #1EA185 !important;">
                    <tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="3"></td>
                        <td align="right" colspan="2" style="background-color: white">Total Amount</td>

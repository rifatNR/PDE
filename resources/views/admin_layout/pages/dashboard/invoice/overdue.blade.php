...
<div class="container">
  <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
      <a class="nav-link" href="{{ route('admin.invoice.all') }}">All Invoices</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="{{ route('admin.invoice.inew') }}">New</a>
    </li>
        <li class="nav-item">
      <a class="nav-link active" href="{{ route('admin.invoice.overdue') }}">Overdue</a>
    </li>
    <li class="nav-item">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu btn btn-sm" aria-labelledby="dropdownMenuButton">
                          ...
                          <a class="dropdown-item btn btn-sm" href="{{ route('admin.invoice.approve', ['id'=>$invoice->id]) }}">Approve</a>
                          @endif
                        ...
                        <div class="container-fluid">
                          <form action="{{route('admin.invoice.payment')}}" method="POST" onsubmit="validate(event)">
                            ...
                            <div class="row" style="margin-top: -17px">
                                ...
                                <div class="col-sm">
                                    <input type="number" name="ref_gift" id="ref_gift" class="form-control">
                                </div>
                            </div>
                            @endif
                      </div>

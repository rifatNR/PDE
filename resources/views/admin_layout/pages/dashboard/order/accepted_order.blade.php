...
@section('content')
    <div class="card">
        <div class="card-header">
            <i class="fas fa-vote-yea mr-3" aria-hidden="true"></i>
            Accepted Orders
        </div>
        <div class="card-body">
                          ...
                          <td>
                            <div class="btn-gropup">
                                <span data-toggle="tooltip" data-theme="dark" title="Details" class="m-2">
                                  <a href="{{ route('admin.order.info', ['id'=>$order->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-info-circle"></i></a>
                                </span>
                                {{-- <input class="start_time" type="hidden" value="{{ $order->starting_date }}" id="h_start"> --}}

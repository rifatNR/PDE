...
@section('title')
    <title>Contact | Photo Design Expert</title>
@endsection
@section('content')
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4" data-aos="fade-right">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>House 153, Word 11, South Hossainpur Sirajganj, Near Upazila Office, Sirajganj</p>
                            </div>

                            <div class="email">
                                <i class="icofont-envelope"></i>
                                <h4>Email:</h4>
                                <p>info@photodesignexpert.com</p>
                            </div>
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
                        ...
                        <form action="{{ route('user.contact.post') }}" method="post" role="form" class="php-email-form">
                            @csrf
                            <div class="form-row">
